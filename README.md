...
```bash
screen-sketch render < input.yaml > output.svg
```

引数はありません。YAML は標準入力から読み取り、SVG は標準出力に書き出します。
...
詳細は [vscode-screen-sketch/README.md](vscode-screen-sketch/README.md) を参照してください。
